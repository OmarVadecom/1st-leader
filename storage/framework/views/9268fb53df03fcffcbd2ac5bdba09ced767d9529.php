                ...
                <div class="card-header">
                    ...
                    <div class="heading-elements">
                        <ul class="list-inline mb-0">
                            ...
                            <?php echo getCreateBtn(route('role.create'), 'roles.create'); ?>

                            <?php echo getDeleteBtn(route('admin.role.deletes'), 'roles.delete'); ?>
                        ...
                        <table class="table table-striped table-bordered " id="data">
                         <thead>
                            <tr>
                                <th>#</th>
                                <th></th>
                                <th><?php echo e(trans('admin.name', ['name' => trans('admin.role')])); ?></th>
...
<script type="text/javascript">
    ...
    var t =$('#data').DataTable( {
        ...
        //"fixedHeader": true,
        "responsive": true,
        "ajax": "<?php echo e(route('admin.role.ajax')); ?>",
        "columns": [
           {data: null, name: null},
           {data: 'select', name: ''},
           {data: 'name', name: 'name'},
