                ...
                <div class="card-header">
                    ...
                    <div class="heading-elements">
                        <ul class="list-inline mb-0">
                            ...
                            <?php echo getCreateBtn(route('tmpclients.create').'?status='.Request::get('status'),
                            'product.create'); ?>
...
<script type="text/javascript">
   ...
   var t= $('#data').DataTable( {
        ...
        "fixedHeader": true,
        "responsive": true,
        "ajax": "<?php echo e(route('admin.tmpclients.ajax')); ?>?status=<?php echo e(\Request::get('status')); ?>",
        "columns": [
           {data: null, name: null},
           {data: 'select', name: ''},
