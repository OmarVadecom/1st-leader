            ...
            <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if(isset($item)): ?>
                    <tr><input type="hidden" name="product[]" value="<?php echo e($item->id); ?>">
                        ...
                        <td><input type="number" value="<?php echo e($quantities[$k]); ?>" data-number="<?php echo e($k); ?>" placeholder="الكميه"
                                   min="1"
                        ...
                        <td><input type="number" value="<?php echo e(round($prices[$k],2)); ?>" data-number="<?php echo e($k); ?>" step="any"
                                   placeholder="السعر" min="1" class="prices form-control productprice price<?php echo e($k); ?>"
                                   name="price[]">
                        </td>
                        <td class="totals totalfir<?php echo e($k); ?>">
                            <?php echo e(round($prices[$k]*$quantities[$k],2)); ?></td>
                        <td><input type="number" value="<?php echo e($discounts[$k]); ?>" data-number="<?php echo e($k); ?>" placeholder="الخصم %"
                                   min="0"
                    ...
                    $total_after_disc=$prices[$k] * $quantities[$k] - $discount;
                        ...
                        <td><input type="number" value="<?php echo e($taxes[$k]); ?>" data-number="<?php echo e($k); ?>" placeholder="الضريبه"
                                   min="0"
                                   class="prices form-control productdreba dareba<?php echo e($k); ?>" name="darebadis[]"
                                   style="width:85%"
                        ...
                        <td class="totals total<?php echo e($k); ?>"><input id="total_input" type="number" step="any"
                                                              data-number="<?php echo e($k); ?>"
                                                              name="totals[]"
                                                              value="<?php echo e(round($total_after_disc + $dreba,2)); ?>"
