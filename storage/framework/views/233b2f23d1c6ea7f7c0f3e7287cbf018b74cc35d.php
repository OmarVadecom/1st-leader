    ...
    <h3 class="header-3">
      فاتوره بيع  <?php echo e($offer->type == 2 ? 'طلب ورشه' : ''); ?>
        ...
        <?php if(in_array(auth()->id(), [1, 7, 9])): ?>
            <a href="<?php echo e(route('sells.edit',$offer->id)); ?>?m=<?php echo e($offer->maintenance_id); ?>" class="editbtu" target="_blank"> - تعديل </a>
        <?php endif; ?>
    </h3>
  </div>
</div>
  ...
  <div class="col-md-3">
    ...
    <div class="row no-gutters" style="border: 1px solid #ccc; border-bottom: 0px;">
      <div class="d-flex">
        ...
        <span class="about_value en-font"><?php echo e($customer->dreb_number != '' ? $customer->dreb_number : 'لا يوجد'); ?></span>
      </div>
    </div>
  </div>
  ...
  <div class="col-md-3">
    <div class="row no-gutters">
      ...
      <div class="col-md-6">
        ...
        <div class="row no-gutters " style="border: 1px solid #ccc;border-bottom: 0px; border-right: 0; ">
          <span class="about_value en-font"><?php echo e($offer->code); ?></span>
        </div>
