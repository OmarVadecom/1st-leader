            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select
                            <?php if( !isset($maintenance) || ((isset($maintenance) && $maintenance->client_id) == null || (isset($maintenance) && $maintenance->client_id == 0) || (isset($maintenance) && $maintenance->client_id == '0')) ): ?>
                                required
                            <?php endif; ?>
                        ...
                        >
                            ...
                            <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option
                                    <?php echo e((isset($maintenance) && $maintenance->client_id == $customer->id) ? 'selected' : ''); ?>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" value="<?php echo e(isset($maintenance->time) ? $maintenance->time : date('h:i:s A')); ?>" required name="time"
                               class="form-control">
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group<?php echo e($errors->has(" name") ? " has-error" : ""); ?>">
                        ...
                        <?php echo Form::number("quantity", null, [
                        "class" => "form-control",
                        "placeholder" => 'الكميه',
