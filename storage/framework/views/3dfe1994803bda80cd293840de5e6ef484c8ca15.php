                ...
                <div class="card-header">
                    ...
                    <div class="heading-elements">
                        <ul class="list-inline mb-0">
                            ...
                            <?php echo getCreateBtn(route('parts.create'), 'products.create'); ?>

                            <?php echo getDeleteBtn(route('admin.parts.deletes'), 'products.create'); ?>
                        ...
                        <table class="table table-striped table-bordered " id="data">
                            <thead>
                                <tr>
                                    ...
                                    <th>الصوره</th>
                                    <th>الشركه</th>
                                    <th width="18%"><?php echo e(trans('admin.action')); ?></th>
                                </tr>
                            </thead>
                            <tbody>
...
<script type="text/javascript">
    $(document).ready(function () {
        var t = $('#data').DataTable({
            ...
            "fixedHeader": true,
            "responsive": true,
            "ajax": "<?php echo e(route('admin.parts.ajax')); ?>",
            "columns": [{
                    data: null,
                    name: null
                },
    ...
    $('#imgupload').on('submit', function (e) {
        ...
        if (multiId.length === 0) {
            ...
            $.ajax({
                url: "<?php echo e(route('admin.uploadpartsimg')); ?>",
                type: "POST",
                data: formData,
