        ...
        <div class="col-md-12">
            <?php if(isset($charts) && $charts[0] != ""): ?>
                <?php $__currentLoopData = $charts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$chart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <input id="filechart<?php echo e($key); ?>_name" type="hidden" name="charts_names[]"
                        value="<?php echo e($charts_names[$key]); ?>">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $charts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$chart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td> <a href="<?php echo e(url('/')); ?>/uploads/products-charts/<?php echo e($chart); ?>"
                                                class="filechart<?php echo e($key); ?>" download><input id="file<?php echo e($key); ?>"
                                                    type="hidden" name="charts_edit[]" value="<?php echo e($chart); ?>">
                                                <?php echo e($chart); ?></a></td>
                                        <td><i id="btu-filechart<?php echo e($key); ?>" style="color:red"
                                                class="fa fa-times clickremchart"></i></td>
                                    </tr>
