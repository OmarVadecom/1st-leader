...
$("#addinputf").click(function(){
    $("#filesinput").append('<div class="row"> <div class="col-md-6"> <?php echo Form::text("attachment_names[]", "", [ "class" => "form-control", "placeholder" => "اسم المستند", ]); ?> </div> <div class="col-md-4"> <input accept=".xlsx,.xls,image/*,.doc, .docx,.ppt, .pptx,.txt,.pdf" type="file" name="attachments[]"> </div> <div class="col-md-2"> </div> </div> <br>');
     return false;
 })
...
$("#addspecification").append('<?php echo Form::text("description[]", "", [ "class" => "form-control", "placeholder" => "معلومات المنتج", ]); ?><br>');
return false;
})

$("#add-pro-in").click(function(){

$("#addproductsin").append('<select name="products_in[]" class="form-control tagsadd" id=""> <option value="">اختر المنتج</option> <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <option value="<?php echo e($product->id); ?>"><?php echo e($product->name); ?> | <?php echo e($product->code); ?> </option> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> </select><br>');
$(".tagsadd").select2({
      tags: true
    });
return false;
