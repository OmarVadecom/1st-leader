<div class="tab-pane  fade" id="menu9">
  <div class="col-md-12">
      ...
      <tbody class="productsadd">
        <div class="form-group ">
          ...
          <tr>
            ...
            <td>
              <div class="checkbox">
                ...
                <label><input type="checkbox" name="group_status[<?php echo e($key); ?>]" <?php echo e(($group_statuss[$key]==1) ? 'checked' : ''); ?>> اجباريه </label>
              </div>
            </td>
          ...
          <tr>
            ...
            <td>
              <input type="number" value="1" placeholder="الكميه" min="1" class="form-control productquantity" name="">
            </td>
            <td>
              <div class="checkbox">
    ...
    <button id="add-product" style="float:left; margin-top:10px; margin-bottom:10px;" class="btn btn-success">اضف منتج
      أخر</button>
