                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="customer_id" class="form-control select2 selectproduct" required>
                            ...
                            <?php $__currentLoopData = $customerss; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($customer->id); ?>"
                                <?php echo e($customer->id==$maintenance->customer_id ? 'selected' : ''); ?>>
            ...
            <div class="col-md-12">
                <table id="added_products_table" class="table table-striped" style="text-align:center">
                    ...
                    <tbody id="table_body" class="productsadd">
                        ...
                        <?php if(isset($maintenance)): ?>
                        <input type="hidden" name="maintenance_id" value="<?php echo e($maintenance->id); ?>">
                        <?php $__currentLoopData = $offer_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td> <?php echo e(isset($product->name) ? $product->name : ''); ?></td>
                            <td class="<?php echo e($k); ?>"></td>
                            <td>
                                <input type="hidden" value="<?php echo e($offer_products_quantities[$k]); ?>" data-number="<?php echo e($k); ?>"
                                    placeholder="الكميه" min="1"
                                    class="quantities form-control productquantity quantity<?php echo e($k); ?>" name="quantity[]">
                                <span class="quantity<?php echo e($k); ?>"><?php echo e($offer_products_quantities[$k]); ?></span>
                            </td>
                            <td><input type="number" value="" data-number="<?php echo e($k); ?>" placeholder="المسلم" min="0"
                                    max="<?php echo e($offer_products_quantities[$k]); ?>"
                                    class="prices form-control productprepared prepared<?php echo e($k); ?>" name="delivered[]">
                            </td>
                            <td><span class="remains<?php echo e($k); ?>"></span></td>
                            <td>
                        ...
                        <?php endif; ?>
                        <?php if(isset($edit)): ?>
                        <?php $__currentLoopData = $delivery_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <input type="hidden" name="product[]" value="<?php echo e($product->id); ?>">
                            <input type="hidden" name="product_code_type[]" value="<?php echo e($product->code_type); ?>">
                            ...
                            <td><span class="preparedpro<?php echo e($k); ?>"><?php echo e($product->delivered); ?></span></td>
                            <td>
                                <?php if($product->remains != 0): ?>
                                <input type="number" value="" data-number="<?php echo e($k); ?>" placeholder="المسلم" min="0"
                                    max="<?php echo e($product->remains); ?>"
                                    class="prices form-control productprepared prepared<?php echo e($k); ?>" name="delivered[]">

                                <?php else: ?>
                                <span> <i style="color:green" class="fa fa-check"></i></span>
                                <input type="hidden" value="<?php echo e($product->delivered); ?>" name="delivered[]">
                                <?php endif; ?>
                            </td>
...
<script type="text/javascript">
    ...
    var k ='<?php if(isset($edit)||isset($verify)): ?> <?php echo e(count($delivery_products)); ?> <?php else: ?><?php echo e(0); ?><?php endif; ?>';
