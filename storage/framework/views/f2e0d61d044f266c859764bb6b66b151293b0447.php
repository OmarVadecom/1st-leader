                ...
                <div class="card-header">
                    ...
                    <div class="heading-elements">
                        <ul class="list-inline mb-0">
                            ...
                            <?php echo getCreateBtn(route('expense.create'), 'product.create'); ?>
                ...
                <div class="card-body collapse in">
                    <div class="card-block card-dashboard">
                        ...
                        <button style="float:left"
                            onclick="window.location.href='<?php echo e(route('brands.create')); ?>';">
                            اضافه مصروف مؤسسه أخر
                        </button>
                    </div>
                </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        var t = $('#data').DataTable({
            ...
            "fixedHeader": true,
            "responsive": true,
            "ajax": "<?php echo e(route('admin.expense.ajax')); ?>",
            "columns": [{
                    data: null,
                    name: null
                },
