                ...
                <div class="card-header">
                    <h4 class="card-title">
                        ...
                        <?php if(\Request::get('category_id')): ?>
                            ...
                            ?>
                            (قسم <?php echo e($cuscat->name); ?>)

                        <?php elseif(\Request::get('parent_id')): ?>
                            <?php
                                $cuscat=\App\Models\Customers::find(\Request::get('parent_id'));
                            ?>
                            (للعميل الرئيسي <?php echo e($cuscat->name); ?>)
                    ...
                    <div class="heading-elements">
                        <ul class="list-inline mb-0">
                            ...
                            <?php echo getCreateBtn(route('customers.create'), 'users.create'); ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        var t = $('#data').DataTable({
            ...
            //"fixedHeader": true,
            "responsive": true,
            "ajax": "<?php echo e(route('admin.customers.ajax')); ?>?category_id=<?php echo e(\Request::get('category_id')); ?>&parent_id=<?php echo e(\Request::get('parent_id')); ?>",
            "columns": [{
                    data: 'code',
                    name: 'code'
                },
