  ...
  <div class="main-menu-content">
    ...
    <li class="nav-item has-sub"><a href="#"><span class="icon"><i class="fa fa-shopping-cart"></i></span><span
      ...
      <ul class="menu-content" style="">
        ...
        <li class="is-shown"><a href="<?php echo e(route('admin.sellsmnt.index')); ?>?main_type=1" class="menu-item">فواتير بيع الورشه</a>
        </li>
      </ul>
    </li>
    ...
    <li class="nav-item has-sub"><a href="#"><span class="icon"><i class="fa fa-shopping-cart"></i></span><span
      ...
      <ul class="menu-content" style="">
        <li class="is-shown">
          <a href="<?php echo e(route('admin.sellsint.index')); ?>" class="menu-item">
            فواتير البيع الداخليه
          </a>
        </li>
        <li class="is-shown"><a href="<?php echo e(route('sells.index')); ?>" class="menu-item">فواتير مبيعات المعرض</a>
        </li>
