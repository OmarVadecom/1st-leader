                    ...
                    <div class="heading-elements">
                        <ul class="list-inline mb-0">
                            ...
                            <?php if(\Request::get('pur_type')): ?>
                                <?php echo getCreateBtn(route('purchase.create').'?pur_type=1', 'product.create'); ?>

                            <?php else: ?>
                                <?php echo getCreateBtn(route('purchase.create'), 'product.create'); ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        var t = $('#data').DataTable({
            ...
            "fixedHeader": true,
            "responsive": true,
            "ajax": "<?php echo e(route('admin.purchase.ajax')); ?>?pur_type=<?php echo e(\Request::get('pur_type')); ?>",
            "columns": [{
                    data: null,
                    name: null
                },
