                ...
                <div class="card-header">
                    ...
                    <div class="heading-elements no-print">
                        <ul class="list-inline mb-0">
                            ...
                            <?php echo getCreateBtn(route('purchases-prices-offers.create') . '?type=' . $type, 'users.create'); ?>
                        ...
                        <table class="table table-striped table-bordered " id="data">
                            <thead>
                                <tr>
                                    ...
                                    <th class="headpr"><?php echo e(trans('admin.action')); ?></th>
                                </tr>
                            </thead>
                            <tbody></tbody>
...
<script type="text/javascript">
    ...
    var t =$('#data').DataTable( {
        ...
        "fixedHeader": true,
        "responsive": true,
        "ajax": "<?php echo e(route('admin.purchases-prices-offers-ajax.ajax')); ?>?type=<?php echo e($type); ?>",
        "columns": [
