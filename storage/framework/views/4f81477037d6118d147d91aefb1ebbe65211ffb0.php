    ...
    <div class="col-xs-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">
            الزيارات
            <a class="btn btn-primary" href="<?php echo e(url('/')); ?>/mapvisits?type=all">خريطه الزيارات</a>
            <a class="btn btn-primary" href="<?php echo e(url('/')); ?>/mapvisits?type=target">خريطه الزيارات
              المستهدفه</a>
            <a class="btn btn-primary" href="<?php echo e(url('/')); ?>/mapvisits?type=done">خريطه الزيارات المنفذه</a>
          </h4>
        </div>
...
<script>
  ...
  ['<?php echo e($visit->customer->name); ?>', '', '<?php echo e(url("/")); ?>/visits/<?php echo e($visit->id); ?>/edit','<?php echo e($visit->lat); ?>','<?php echo e($visit->lng); ?>','<?php echo e($visit->type); ?>'],
