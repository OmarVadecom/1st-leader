<?php $__env->startSection('title'); ?> فاتورة شراء <?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>
    ...
    <div class="row no-gutters">
        <div class="col-md-12 text-center" style="border: 1px solid #ccc">
            <h3 class="header-3">
                فاتورة شراء
                <a href="<?php echo e(route('purchases.edit', $purchase->id)); ?>" class="editbtu" target="_blank"> - تعديل </a>
            </h3>
        </div>
    </div>
            ...
            <div class="row no-gutters">
                ...
                <div class="col-md-6">
                    <div class="row no-gutters" style="border: 1px solid #ccc;border-bottom: 0px; border-top: 0; border-right: 0; ">
                        <span class=" about_value en-font"><?php echo e($purchase->date); ?></span>
                    </div>
                    <div class="row no-gutters " style="border: 1px solid #ccc;border-bottom: 0px; border-right: 0; ">
                        <span class="about_value en-font"><?php echo e($purchase->time); ?></span>
                    </div>
                    <div class="row no-gutters " style="border: 1px solid #ccc;border-bottom: 0px; border-right: 0; ">
                        <span class="about_value en-font"><?php echo e($purchase->code . '-' . str_pad(request('invoice_num'), 4, '0', STR_PAD_LEFT)); ?></span>
                    </div>
