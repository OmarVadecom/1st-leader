    ...
    <div class="row">
        <div class="col-md-6">
            <div
                ...
                <?php echo Form::text("name", isset($country) ? $country->name : "", [
                "class" => "form-control",
                "placeholder" => 'الاسم',
                "required"
                ]); ?>
        ...
        <div class="col-md-3">
            ...
            <input type="hidden" name="oldimage"
                value="<?php echo e((isset($country)) ? $country->image : ''); ?>">
        </div>
        <div class="col-md-3">
            <?php if(isset($country)): ?>
                <img src="<?php echo e(asset('uploads/countries/'.$country->image)); ?>"
