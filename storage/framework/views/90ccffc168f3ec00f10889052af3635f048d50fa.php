...
<div class="row no-gutters">
    <div class="col-md-12 text-center" style="border: 1px solid #ccc">
        <h3 class="header-3">
            تقرير ورشه <a href="<?php echo e(route('maintenance_report.edit', $maintenance_report->id) . '?main_type=' . request('main_type') . '&invoice_num=' . str_pad(request('invoice_num'), 4, '0', STR_PAD_LEFT)); ?>" class="editbtu"
                target="_blank"> - تعديل
            </a>
        </h3>
    </div>
        ...
        <div class="row no-gutters">
            ...
            <div class="col-md-6">
                <div class="row no-gutters"
                    ...
                    <span class=" about_value en-font"><?php echo e($maintenance_report->created_at->toDateString()); ?></span>
                </div>
                <div class="row no-gutters " style="border: 1px solid #ccc;border-bottom: 0px; border-right: 0; ">

                    <span class="about_value en-font"><?php echo e(date('h:i:s A', strtotime($maintenance_report->created_at))); ?></span>
                </div>
