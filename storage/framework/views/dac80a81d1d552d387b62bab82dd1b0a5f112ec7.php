        ...
        <div class="navbar-header" style="background: #ffffff;">
            <ul class="nav navbar-nav">
                ...
                <li style="width: 100%;" class="nav-item"><a style="width: 100%;margin-left: -7px;padding: 11px 0px;"
                            ...
                            data-collapse="<?php echo e(url('/')); ?>/uploads/logo/<?php echo e(getSettings('site_logo')); ?>"
            ...
            <div id="navbar-mobile" class="collapse navbar-toggleable-sm">
                <ul class="nav navbar-nav float-xs-right">
                    ...
                    <?php if(in_array(auth()->id(), [1, 9])): ?>
                        <li class="dropdown dropdown-notification nav-item message-content">
                            <?php echo $__env->make($pLayout.'boxs.warranties_notifications', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        </li>
                    <?php endif; ?>
