                    ...
                    <div class="card-block card-dashboard">
                        <table class="table table-striped table-bordered " id="data">
                         <thead>
                            <tr>
                                <th>#</th>
                                <th></th>
                                <th style="width:30%">{{ trans('admin.title', ['name' => trans('admin.page')])  }}</th>
                                <th style="width:20%">{{ trans('admin.slug', ['name' => trans('admin.slug')])  }}</th>
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th>{{ trans('admin.slug', ['name' => trans('admin.slug')])  }}</th>
