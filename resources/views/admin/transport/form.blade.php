            ...
            <div class="col-md-12">
                <table id="added_products_table" class="table table-striped" style="text-align:center">
                    ...
                    <tbody id="table_body" class="productsadd">
                        @if(isset($edit))
                        @foreach($transport_products as $k => $product )
                        @php
                        $tr_pro=\App\Models\Products::find($product);
                        @endphp
                        <tr>
                            <input type="hidden" name="product[]" value="{{$tr_pro->id}}">
                            <input type="hidden" name="product_code_type[]" value="">
                            <td> {{$tr_pro->code}} </td>
                            <td> {{$tr_pro->name or ''}}</td>
                            <td>
                                <input type="number" class="form-control" name="quantity[]" value="{{$quantities[$k]}}"
                                    required>
                            </td>
                            <td>
                                <select class="form-control" name="ware_from[]" required>
                                    ...
                                    <option {{$warehouse->id==$ware_from[$k] ? 'selected':''}}
                            ...
                            <td>
                                <select class="form-control" name="ware_to[]" required>
                                    <option value="">اختر المستودع</option>
                                    @foreach($warhouses as $warehouse)
                                    <option {{$warehouse->id==$ware_to[$k] ? 'selected':''}} value="{{$warehouse->id}}">
                            ...
                            <td>
                                <select class="form-control" name="user[]">
                                    ...
                                    <option value="{{$user->id}}" {{$user->id == $users_id[$k] ? 'selected':''}}>
                                        {{$user->name}}
                                    </option>
                                    @endforeach
                                </select>
...
<script type="text/javascript">
    ...
    var k ='@if(isset($edit)||isset($verify)) {{count($transport_products)}} @else{{0}}@endif';
