            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="heading-elements">
                        <ul class="list-inline mb-0">
                            ...
                            {!! getCreateBtn(route('expensecategory.create'), 'product.create') !!}
                ...
                <div class="card-body collapse in">
                    <div class="card-block card-dashboard">
                        ...
                        <button style="float:left" onclick="window.location.href='{{route('brands.create')}}';">
                            اضافه قسم أخر
                        </button>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    var t=$('#data').DataTable( {
        ...
        "fixedHeader": true,
        "responsive": true,
        "ajax": "{{ route('admin.expensecategory.ajax') }}",
        "columns": [
            {data: null, name: null},
           {data: 'select', name: ''},
           {data: 'code', name: 'code'},
