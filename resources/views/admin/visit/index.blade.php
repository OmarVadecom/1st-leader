        ...
        <div class="col-xs-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">
                        الزيارات
                        <a class="btn" href="{{url('/')}}/mapvisits?type=all">خريطه الزيارات</a>
                        <a class="btn" href="{{url('/')}}/mapvisits?type=target">خريطه الزيارات
                            المستهدفه</a>
                        <a class="btn" href="{{url('/')}}/mapvisits?type=done">خريطه الزيارات المنفذه</a>
                    ...
                    <div class="heading-elements">
                        <ul class="list-inline mb-0">
                            ...
                            {!! getCreateBtn(route('visits.create'), 'products.create') !!}
                        </ul>
                    </div>
                </div>
