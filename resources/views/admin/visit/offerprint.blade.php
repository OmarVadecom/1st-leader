            ...
            <div class="row mt-4">
                ...
                <table class="table table-striped table-responsive-md table-1" border=1>
                    ...
                    <tbody>
                        ...
                        $total='';
                        foreach($headers as $header){
                        if(is_numeric($lastrow[$header])){
                        $total=$lastrow[$header];
                        }
                        }
                        $totaldareby=$total+18900.0;
                        @endphp
                    </tbody>
                </table>

                <table class="table table-striped table-responsive-sm table-2" border="1">
                    <thead style="position: relative">
                        <tr>
                            <td style="padding:0px;padding-left: 10px;" class="total-prop">الاجمالي</td>
                            <td style="padding:0px;" class="total-value">{{number_format($total)}}</td>
                            <td style="padding:0px;" class="total-prop"></td>
                        </tr>
                        <tr>
                            <td style="padding:0px;padding-left: 10px;" class="total-prop">الخصم</td>
                            <td style="padding:0px;" class="disc-rate text-center">0%</td>
                            <td style="padding:0px;" class="client-comments"> ملاحظات لدى العميل</td>
                        </tr>
                        <tr>
                            <td>
                                <div class="row justify-content-center align-items-center">
                                    ...
                                    <br>
                                    <p class="text">
                                        الرقم الضريبي <span class="tax-number">300235684700003</span>
                                    </p>
                                    <br>
                                    <br>
                                    <br>
                            ...
                            <td>
                                <div class="row no-gutters align-items-center justify-content-around">
                                    <div class="col-md-12">
                                        <li class="d-flex">
                                            <span class="about_prop about_prop-2">الخصم</span>
                                            <span>- ر.س.</span>
                                        </li>
                                    </div>
                                ...
                                <div class="row no-gutters align-items-center justify-content-around">
                                    <div class="col-md-12">
                                        <li class="d-flex">
                                            <span class="about_prop about_prop-2">الضريبة المضافة</span>
                                            <span>18,900.00 ر.س.</span>
                                        </li>
                                    </div>
                                ...
                                <div class="row no-gutters align-items-center justify-content-around">
                                    <div class="col-md-12">
                                        <li class="d-flex">
                                            <span class="about_prop about_prop-2">صافي الإجمالي</span>
                                            <span>{{number_format($totaldareby)}} ر.س.</span>
                                        </li>
                                    </div>
