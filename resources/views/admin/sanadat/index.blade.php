                ...
                <div class="card-header">
                    ...
                    <div class="heading-elements">
                        <ul class="list-inline mb-0">
                            ...
                            {!! getCreateBtn(route('sanadat.create').'?type='.\Request::get('type'), 'product.create')
                            !!}
                        ...
                        <table class="table table-striped table-bordered " id="data">
                            <thead>
                                <tr>
                                    ...
                                    <th></th>
                                    <th>النوع</th>
                                    <th>{{\Request::get('type') == 1 ? 'السند من' : 'نوع السند'}}</th>
                                    <th>التكلفه</th>
...
<script type="text/javascript">
    ...
    var t=$('#data').DataTable( {
        ...
        "fixedHeader": true,
        "responsive": true,
        "ajax": "{{ route('admin.sanadat.ajax') }}?type={{\Request::get('type')}}",
        "columns": [
