...
<div style="direction:rtl;" id="printthis">
        ...
        <div class="container">
            ...
            <div class="row no-gutters" style="border: 1px solid black">
                ...
                <div class="col-md-11 flx">
                    <a class="link"
                        href="https://www.google.com.sa/maps/@{{$visit->lat}},{{$visit->lng}},89m/data=!3m1!1e3?hl=ar"
                        target="_blank">الموقع علي الخريطه</a>
                    <br>
                    <br>
                    <br>
                    <br>
    ...
    top: 4px;">
                ...
                <div class="col-md-11">
                    <p class="text">تشهد كافة الإجراءات المتبعة لدى مؤسسة القائد الأول بصحة البيانات المسجلة في هذا
                        النموذج .</p>
                </div>
            </div>
            <div class="row no-gutters" style="border: 1px solid black">
    ...
    top: 4px;">
                ...
                <div class="col-md-11">
                    <p class="text">
                        تؤكد مؤسسة القائد الأول في هذا النموذج والنموذج المرفق للخريطة صحة ودقة بيانات موقع العميل
                        بالإحداثيات العالمية المعتمدة من نظام خرائط GOOGLE .
                    </p>
                </div>
            </div>
            <div class="row no-gutters" style="border: 1px solid black">
    ...
    top: 4px;">
                ...
                <div class="col-md-11">
                    <p class="text">
                        يؤكد العميل والمشرف المعمد لديه على صحة البيانات المقدمة من جهته وإعتمادها كجزء من ضهن باقي
                        الإجراءات الرسمية المتفق عليها بين الطرفين .
                    </p>
                </div>
            </div>
            <div class="row no-gutters">
