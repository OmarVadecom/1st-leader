    ...
    <header class="header">
        <div class="container">
            <div class="row">
                <!-- Arabic Address-->
                <div class="col-md-4">
                    <h1 class="header-1 b-red mb-2 text-center">{{getSettings()}}</h1>
                    <p class="text-center font-weight-bold p-desc">{{getSettings('site_desc')}}</p>
                    <div class="d-flex">
                        <div>
                            <span class="about_prop">هاتف :</span>
                            <span class="about_value en-font"> &#x200E;{{getSettings('site_phone')}}</span>
                        </div>
                        <div>
                            <span class="about_prop">فاكس :</span>
                            <span class="about_value en-font"> &#x200E;{{getSettings('site_fax')}}</span>
                        </div>

                    </div>
                    <div>
                        <span class="about_prop">ص-ب :</span>
                        <span class="about_value en-font"> {{getSettings('site_po')}} - جده {{getSettings('site_zip')}}</span>
                    </div>
                    <div>
                        <span class="about_prop">س-ت :</span>
                        <span class="about_value en-font">{{getSettings('site_cr')}}</span>
                    </div>
                    <div>
                        <span class="about_prop">العنوان :</span>
                        <span class="about_value ">{{getSettings('site_address')}}</span>
                    </div>
                </div>
                <!-- Logo -->
                <div class="col-md-4 col-xs-12 col-xs-order">
                    <a href="index-update.html" class="mb-2">
                        <img src="{{url('/')}}/uploads/logo/{{getSettings('site_logo')}}" alt="{{getSettings()}}"
                            class="img-fluid">
                    </a>
                    <p class="text-center">
                        <a class="mail-address en-font" href="mailto:{{getSettings('site_email')}}" class="">
                ...
                <div class="col-md-4 en-font">
                    <h1 dir="ltr" class="header-1 b-red mb-2 text-center" style="font-size:2.6rem;">
                        {{getSettings('title',null,'en')}}.</h1>
                    <p class="text-center font-weight-bold p-desc">{{getSettings('site_desc','','en')}}</p>
                    <div class="d-flex" dir="ltr">
                        <div dir="auto">
                            <span class="about_prop">tel :</span>
                            <span dir="ltr" class="about_value"> {{getSettings('site_phone','','en')}}</span>
                        </div>
                        <div dir="ltr">
                    ...
                    <div dir="ltr" class="text-left">
                        ...
                        <span class="about_value"> {{getSettings('site_po','','en')}} - Zip-Code:
                            {{getSettings('site_zip','','en')}}</span>
                    </div>
                    <div dir="ltr" class="text-left">
