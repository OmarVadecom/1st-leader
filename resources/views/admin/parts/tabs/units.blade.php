    ...
    <div class="col-md-12 unitsrows">
            ...
            <div class="col-md-5">
                ...
                <div class="form-group">
                    <label><input type="radio" value="1"
                            {{ (isset($units) && $unit_default==1) ? 'checked' : '' }}
        ...
        @if(isset($units) && count($units) > 1)
            @foreach($units as $index=>$unit)
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group"> <label>الوحده {{ $index+2 }}</label> {!! Form::text("units[]", $unit,
                            [ "class" =>
                            "form-control",
                    ...
                    <div class="col-md-4">
                        <div class="form-group"> <label>عامل التحويل</label> {!!
                            Form::number("units_cons[]",$units_cons[$smindex] , [
                            "class" => "form-control", "placeholder" => "عامل التحويل", ]) !!} </div>
                        <!-- /.form-group -->
                    </div>
                    <div class="col-md-4">
                        <div class="form-group"> <label>رمز الباركود</label> {!! Form::text("units_barcode[]",
                            $units_barcode[$index] ,
                            [ "class" =>
                ...
                <div class="form-group"> <label><input type="radio" value="{{ $index+2 }}"
                            {{ (isset($units) && $unit_default==$index+2) ? 'checked' : '' }}
      ...
      <div class="form-group">
        <label><input type="radio" value="2" name="unit_status"
            {{ (isset($product) && $unit_status == 2) ? 'checked' : '' }}>
        الافتراضي
        </label>
        <br><br>
    </div><!-- /.form-group --> --}}
