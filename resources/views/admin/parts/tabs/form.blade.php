...
<div class="tab-content">
      ...
      <div class="col-md-6">
        <div class="form-group{{ $errors->has(" name") ? " has-error" : "" }}">
          ...
          <select name="bui_cou" class="form-control tagsadd">
            ...
            <option value="{{$pro_country->bui_cou}}" {{(isset($product) && $pro_country->bui_cou==$bui_cou) ?
              'selected' : ''}}>{{$pro_country->bui_cou}}
            </option>
            @endif
            @endforeach
          </select>
      ...
      <div class="col-md-6">
        <div class="form-group{{ $errors->has(" name") ? " has-error" : "" }}">
          ...
          <select name="fact_co" class="form-control tagsadd">
            ...
            @if($pro_fact->fact_co != '')
            <option value="{{$pro_fact->fact_co}}" {{(isset($product) && $pro_fact->fact_co==$fact_co) ? 'selected' :
              ''}}>{{$pro_fact->fact_co}}</option>
            @endif
            @endforeach
          </select>
        </div><!-- /.form-group -->
      ...
      <div class="col-md-6">
        <div class="form-group{{ $errors->has(" name") ? " has-error" : "" }}">
          ...
          <select name="factory" class="form-control tagsadd">
            ...
            <option value="{{$sfactory->id}}" {{(isset($product) && $sfactory->factory==$factory) ? 'selected' :
              ''}}>{{$sfactory->name}}</option>
            @endforeach
          </select>
        </div><!-- /.form-group -->
      </div>
  ...
  <div class="tab-pane container fade" id="menu1">
    <div class="col-md-12">
      ...
      <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
        <label><input type="radio" value="3" name="unit_status" {{(isset($product) && $unit_status==3) ? 'checked' : ''
            }}> الافتراضي
        </label>
      </div><!-- /.form-group -->
            ...
            <tr>
              ...
              <td>
                <div class="checkbox">
                  ...
                  <label><input type="checkbox" name="group_status[{{$key}}]" {{($group_statuss[$key]==1) ? 'checked'
                      : '' }}> اجباريه </label>
                </div>
              </td>
