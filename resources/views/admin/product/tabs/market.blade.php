    ...
    <table class="table table-striped" style="text-align:center">
      ...
      <tbody class="marketadd">
        <div class="form-group ">
          ...
          <tr>
            <td>
              <input type="text" value="{{$supplier}}" placeholder="اسم المورد" class="form-control" name="supplier[]">
            </td>
            <td>
              <input type="date" value="{{$date[$key]}}" placeholder="التاريخ" min="1" class="form-control"
                name="date[]">
            </td>
            <td>
              <input type="text" value="{{$sales_man[$key]}}" placeholder="المندوب " class="form-control"
                name="sales_man[]">
            </td>
            <td>
              <input type="number" value="{{$phone[$key]}}" placeholder="رقم الجوال" min="1" class="form-control"
                name="phone[]">
            </td>
            <td>
              <input type="text" value="{{$price[$key]}}" placeholder="السعر " class="form-control" name="price[]">
            </td>
            <td>
              <input type="text" value="{{$employee[$key]}}" placeholder="اسم الموظف " class="form-control"
                name="employee[]">
            </td>
            <td>
