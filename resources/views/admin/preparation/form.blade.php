...
<div class="card-body">
    <div class="card-block">
        ...
        <div id="product-tab" class="tabcontent" style="display: block;">
            <div class="col-md-12">
                <table id="added_products_table" class="table table-striped" style="text-align:center">
                    ...
                    <tbody id="table_body" class="productsadd">
                        @if(isset($edit))
                        @foreach($preparation_products as $k => $product )
                        <tr>
                            ...
                            <td><span class="preparedpro{{$k}}">{{$product->prepared}}</span></td>
                            <td>
                                @if($product->remains != 0)
                                <input type="number" value="" data-number="{{$k}}" placeholder="المحضر" min="0"
                                    max="{{$product->remains}}"
                                    class="prices form-control productprepared prepared{{$k}}" name="prepared[]">

                                @else
                                <span> <i style="color:green" class="fa fa-check"></i></span>
                                <input type="hidden" value="{{$product->prepared}}" name="prepared[]">
                                @endif
                            </td>
            ...
            @if(!isset($edit))
            @include('admin.product_search.product_search',['preparation'=>true])
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                {!!Form::select('status',[''=>'حالة التحضير','partial'=>'جزئي',
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                {!!Form::textarea('preparation_notes',null,['class'=>'form-control' ,'rows'=>3])!!}
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-md-12">
            ...
            <div class="clear">
                ...
                <a href="{{ route('preparations.index') }}" class="btn btn-danger">
...
<script type="text/javascript">
    ...
    var k ='@if(isset($edit)||isset($verify)) {{count($preparation_products)}} @else{{0}}@endif';
